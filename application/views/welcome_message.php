...
<head>
  ...
  <script type="text/javascript" src="assets/jquery/dist/jquery.min.js"></script>
    <script type="text/javascript" src="assets/js/custom-scroller.js"></script>
  <script>
  $(document)
    .ready(function() {
...
<div class="pusher">
  <div class="ui inverted vertical masthead center aligned segment" 
      style="background-image: url(assets/web-image/homepage.jpg);
    ...
    <div class="ui text container">
      ...
      <h5 style="color:#FFFFFF">Konnichiwa Mina-san^^</h5>
      <h5 style="color:#FFFFFF">Youkoso di E-Learning Nihon-go Club!</h5>
      <br>
      <a href="<?= base_url('login'); ?>" class="ui huge primary button" >Hajimemashou!<i class="right arrow icon"></i></a>
    </div>
...
<script type="text/javascript" src="assets/js/particlesReset.js"></script>
