...
<head>
  ...
  <style type="text/css">
    body {
      background : url(assets/web-image/login.jpg) no-repeat center center fixed;
...
<div class="ui middle aligned center aligned grid">
  <div class="column">
    ...
    <div class="ui message">
        <h3><font color="#4D4F56">Belum daftar?</font> <?= anchor('http://localhost/elearning/login/regist','Daftar disini'); ?>
    </div>
  </div>
</div>
